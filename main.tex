...
\setlength{\leftsepwid}{0.015\paperwidth} % Separation width (white space) between columns
\setlength{\sepwid}{0.02\paperwidth} % Separation width (white space) between columns
\setlength{\leftcolwid}{0.285\paperwidth} % Width of one column
\setlength{\twocolwid}{0.36\paperwidth} % Width of two columns
...
\begin{column}{\leftsepwid}\end{column} % Empty spacer column
...
\begin{itemize}
    \item [] \underline{\textbf{Counting-Generator}}
